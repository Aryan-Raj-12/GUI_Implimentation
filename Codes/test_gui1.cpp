...
HANDLE hSerial;
bool InitSerialComm(LPCWSTR portName) {
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam) {
    ...
    case WM_CREATE:
        ...
        // Buttons
        buttons.push_back(CreateWindowW(L"BUTTON", L"Play", WS_VISIBLE | WS_CHILD, 50, 150, 60, 30, hwnd, NULL, NULL, NULL));
        buttons.push_back(CreateWindowW(L"BUTTON", L"Pause", WS_VISIBLE | WS_CHILD, 120, 150, 60, 30, hwnd, NULL, NULL, NULL));
        buttons.push_back(CreateWindowW(L"BUTTON", L"Settings", WS_VISIBLE | WS_CHILD, 190, 150, 80, 30, hwnd, NULL, NULL, NULL));
        buttons.push_back(CreateWindowW(L"BUTTON", L"TX-ON", WS_VISIBLE | WS_CHILD, 280, 150, 70, 30, hwnd, NULL, NULL, NULL));
        buttons.push_back(CreateWindowW(L"BUTTON", L"TX-OFF", WS_VISIBLE | WS_CHILD, 360, 150, 70, 30, hwnd, NULL, NULL, NULL));
